...
def run_keyword_analysis(posts: list[dict], trends: list[dict]) -> str:
    ...
    prompt = f"""
당신은 일본어 숏폼 유튜브 채널의 콘텐츠 기획자입니다.
한국 반려묘 집사 커뮤니티와 세대별 공감 포인트를 분석하여,
일본어 숏폼 영상의 에피소드 아이디어를 발굴합니다.
...
## 📊 오늘의 핵심 공감 키워드 TOP 10
각 키워드와 왜 공감을 얻는지 1줄 설명
